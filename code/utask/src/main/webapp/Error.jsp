			...
			<div class="container">
				...
				<div class="collapse navbar-collapse navbar-light"
					...
					<ul class="navbar-nav ml-auto pl-lg-5 pl-0">
						...
						<li class="nav-item">
							<%if (loginBool) { %> <a href="index.jsp" class="nav-link"
							onclick="deleteAllCookies()">Logout</a> <%} else { %> <a
					...
					<div class="formSwitcher">
						...
						<div class="form" style="">
							<h2>
								...
								<br>We were unable to process your request.
							</h2>
							<button onclick="location.href='index.jsp';"
								style="margin-top: 30px;">Take Me Home</button>
							</form>
						</div>
					</div>
				</div>
